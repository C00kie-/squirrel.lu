Once you have MISP downloaded (https://www.circl.lu/misp-images/latest/)  and installed on your machine, you connect to it using your browser using the installation credentials.
